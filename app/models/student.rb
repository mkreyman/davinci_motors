class Student < ActiveRecord::Base
  ...
  scope :five_year_olds_today, -> { where(:date_of_birth => 5.years.ago.to_date) }
  scope :teenagers, -> { where(date_of_birth: (20.years.ago)..(13.years.ago)).order(date_of_birth: :desc) }
  def self.seed_data!
    ages = (5..18).to_a
    heights = {
        5  => (40..46).to_a,
